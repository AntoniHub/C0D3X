...
"""Test E2E de la seccion de FAQs - Suscripcion y Facturacion"""
...
def test_06_seguridadDispositivos():
    ...
    driver.get('https://cyberguardian.tawk.help/category/suscripci%C3%B3n-y-facturaci%C3%B3n')
    time.sleep(2.5)
    assert 'Cyber Guardian - Preguntas frecuentes | Suscripción y facturación' in driver.title
...
def test_09_item01():
    """Hacemos click en ¿Cómo puedo continuar usando Cyber Guardian tras pasar el periodo de prueba gratuita?"""
...
def test_13_item02():
    """Hacemos click en ¿Cómo se contrata Cyber Guardian?"""
...
def test_17_item03():
    """Hacemos click en ¿Mi suscripción se renovará automáticamente?"""
...
def test_21_item04():
    """Hacemos click en ¿Puedo utilizar mi bono digital para contratar Cyber Guardian?"""
...
def test_25_item05():
    """Hacemos click en ¿Cómo puedo cancelar mi suscripción?"""
    item05 = driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div/div/div[1]/div[2]/div[2]/div/div/div[5]/a/div[2]/div[1]')
    item05.click()
    time.sleep(2)
...
def test_29_item06():
    """Hacemos click en ¿Qué incluye mi suscripción?"""
    item06 = driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div/div/div[1]/div[2]/div[2]/div/div/div[6]/a/div[2]/div[1]')
    item06.click()
    time.sleep(2)
